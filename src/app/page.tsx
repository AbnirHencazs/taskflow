        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-xl text-gray-600 mb-8">
              ...
              platform. Stay organized, meet deadlines, and achieve more every
              day.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Link
                href="/sign-up"
                className="bg-indigo-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-indigo-700 transition-colors text-center"
              >
                Get Started Free
              </Link>
              <Link
                href="#features"
                className="border-2 border-gray-300 text-gray-700 px-8 py-3 rounded-lg text-lg font-semibold hover:border-indigo-600 hover:text-indigo-600 transition-colors text-center"
              >
                Learn More
              </Link>
            </div>
